...
async function sendAudio() {
    ...
    try {
        ...
        // Parse JSON response containing text and audio
        ...
        // Show user's transcribed text with audio player
        addMessageWithAudio(responseData.user_text, 'user', audioWAVBlob);
        
        // Decode audio from base64
        const audioBytes = new Uint8Array(atob(responseData.audio).split('').map(c => c.charCodeAt(0)));
